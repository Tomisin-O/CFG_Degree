...
### DEMO & EXERCISE 2 ###
"""
Use Python console in PyCharm and practice the following operations together. 
See what happens!
​
5 - 6
8 * 9
...
​
You can copy-paste these examples into your console to save time typing. 
...
# guests = ["Mary", "Pete", "Eoin"]
#
# output = "cin with my classmates {names}.".format(names=', '.join(guests))
#
# print(output)
​
# language = "Python"
# purpose = "String formatting"
# print(f"This is an f-string used in {language} for {purpose}.")
​
### DEMO & EXERCISE 9 ###
"""
